...
export default function AdminCopilotPage() {
  ...
  const [messages, setMessages] = useState(COPILOT_MESSAGES.admin);
  ...
  const handleSend = () => {
    ...
    setTimeout(() => {
      const aiResponses = [
        "I'm analyzing your request... Here's the latest data from the platform.",
        "Great question! Let me pull up the relevant dashboard metrics for you.",
        "Based on current trends, I recommend focusing on the Gulberg corridor for maximum ROI.",
      ];
        ...
        <div className="card" style={{ flex: 1, display: "flex", flexDirection: "column", marginBottom: "24px" }}>
          <div style={{ display: "flex", alignItems: "center", gap: "12px", marginBottom: "16px", paddingBottom: "16px", borderBottom: "1px solid var(--border)" }}>
            ...
            <div>
              ...
              <p style={{ fontSize: "12px", color: "var(--muted)", margin: 0 }}>Ask anything about the platform</p>
            </div>
          </div>
          ...
          <div style={{ display: "flex", gap: "12px", alignItems: "center", borderTop: "1px solid var(--border)", paddingTop: "16px" }}>
            <input
              ...
              placeholder="Ask something like 'Show me today's revenue'..."
              style={{
                flex: 1,
                padding: "12px 16px",
                fontSize: "14px",
