...
export default function OwnerCopilotPage() {
  ...
  const [messages, setMessages] = useState(COPILOT_MESSAGES.owner);
  ...
  const handleSend = () => {
    ...
    setTimeout(() => {
      const aiResponses = [
        "Your property value has increased by 5% this month due to high corridor demand!",
        "You have earned $2,400 from rentals this month, all settled successfully.",
        "I recommend listing your property for rent at $3,000/month to maximize ROI.",
      ];
        ...
        <div className="card" style={{ flex: 1, display: "flex", flexDirection: "column", marginBottom: "24px" }}>
          <div style={{ display: "flex", alignItems: "center", gap: "12px", marginBottom: "16px", paddingBottom: "16px", borderBottom: "1px solid var(--border)" }}>
            ...
            <div>
              ...
              <p style={{ fontSize: "12px", color: "var(--muted)", margin: 0 }}>Ask about your properties or earnings</p>
            </div>
          </div>
          ...
          <div style={{ display: "flex", gap: "12px", alignItems: "center", borderTop: "1px solid var(--border)", paddingTop: "16px" }}>
            <input
              ...
              placeholder="Ask something like 'What is my airspace worth?'..."
              style={{
                flex: 1,
                padding: "12px 16px",
                fontSize: "14px",
